...
```
**If factor count ≠ 169:** Warn that factors.parquet may be outdated (current Alpha158 produces 169).

### Step 1: Factor Coverage Check

Check NaN rates and coverage of all 169 factors.
...
Rolling windows: {5, 10, 20, 30, 60} trading days. Total: 169 factors.
